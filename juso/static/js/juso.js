...
$(function () {
    var search = {
        data: [{
            ...
            name: '360搜',
            img: '/static/images/360.png',
            url: 'https://www.so.com/s?q='
        }, {
            name: '搜狗',
            img: '/static/images/sougou.png',
            ...
            name: 'YaHoo',
            img: '/static/images/yahoo.png',
            url: 'https://search.yahoo.com/search?p='
        }, {
            name: '神马',
            img: '/static/images/shenma.png',
            url: 'http://quark.sm.cn/s?q='
        }, {
            name: '秘迹',
            img: '/static/images/miji.png',
            url: 'https://mijisou.com/?q='
        }, {
            name: 'Duckgo',
            img: '/static/images/Duckduckgo.png',
            ...
            name: 'Lookao',
            img: '/static/images/lookao.png',
            url: 'https://lookao.com/search?q='
        }, {
            name: 'Yandex',
            img: '/static/images/yandex.png',
            url: 'https://yandex.com/search/?text='
        }, {
            name: 'AOl',
            img: '/static/images/aol.png',
            url: 'http://search.aol.com/aol/search?q='
        }, {
            name: 'Yippy',
            img: '/static/images/yippy.png',
            url: 'https://yippy.com/search?query='
        }, {
            name: 'Startpage',
            img: '/static/images/startpage.png',
            url: 'https://www.startpage.com/do/dsearch?query='
        }, {
            name: 'Ecosia',
            img: '/static/images/Ecosia.png',
            url: 'https://www.ecosia.org/search?q='
        }, {
            name: 'Peekier',
            img: '/static/images/peekier.png',
            url: 'https://peekier.com/#!'
        }, {
            name: 'Qwant',
            img: '/static/images/qwant.png',
            url: 'https://www.qwant.com/?q='
        }, {
            name: 'MetaGer',
            img: '/static/images/metager.png',
            url: 'https://metager.de/meta/meta.ger3?eingabe='
        }, {
            name: 'Dogpile',
            img: '/static/images/dogpile.png',
            url: 'https://www.dogpile.com/serp?q='
        }, {
            name: 'Mag[i]',
            img: '/static/images/magi.png',
            url: 'https://magi.com/search?q='
        }, {
            name: 'Goobe',
            img: '/static/images/goobe.png',
            url: 'https://goobe.io/search.aspx?k='
        }, {
            name: 'Torrentz2',
            img: '/static/images/torrentz2.png',
            url: 'https://torrentz2.eu/search?f='
        }, {
            name: 'Acg搜',
            img: '/static/images/acgsou.png',
